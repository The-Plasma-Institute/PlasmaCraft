package net.joelinrome.plasmacraft.worldgen;
...
public class ModBiomeModifiers {
    ...
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, new ResourceLocation(PlasmaCraft.MOD_ID, name));
    }
}
