package net.joelinrome.realisticfusionreactors.worldgen;
...
public class ModBiomeModifiers {
    ...
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, new ResourceLocation(RealisticFusionReactors.MOD_ID, name));
    }
}
