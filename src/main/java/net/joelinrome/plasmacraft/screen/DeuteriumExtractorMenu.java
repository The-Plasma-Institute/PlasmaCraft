...
public class DeuteriumExtractorMenu extends AbstractContainerMenu {
    public final DeuteriumExtractorBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    protected DeuteriumExtractorMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public DeuteriumExtractorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        // Display the player inventory and hotbar within the menu
    ...
    /**
     * If the player is close enough to the block then open the menu
     */
    @Override
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.DEUTERIUM_EXTRACTOR_BLOCK.get());
    }
    ...
    public boolean isCrafting() {
        return data.get(0) > 0; // If the progress data is bigger than zero then draw the arrow
    }
