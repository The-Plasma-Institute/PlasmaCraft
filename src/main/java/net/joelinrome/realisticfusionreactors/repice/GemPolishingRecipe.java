package net.joelinrome.realisticfusionreactors.repice;
...
public class GemPolishingRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Serializer implements RecipeSerializer<GemPolishingRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(RealisticFusionReactors.MOD_ID, "gem_polishing");
